...
#{ disable services
  ...
  RC_TO_DISABLE="$RC_TO_DISABLE autofs autofs5"
  RC_TO_DISABLE="$RC_TO_DISABLE lighttpd"
  ...
  RC_TO_DISABLE="$RC_TO_DISABLE odhcpd"
  RC_TO_DISABLE="$RC_TO_DISABLE atd"
  RC_TO_DISABLE="$RC_TO_DISABLE cron"
  RC_TO_DISABLE="$RC_TO_DISABLE php5-fastcgi"
  RC_TO_DISABLE="$RC_TO_DISABLE dbus"
  RC_TO_DISABLE="$RC_TO_DISABLE dnsmasq"
  RC_TO_DISABLE="$RC_TO_DISABLE avahi-daemon"
  RC_TO_DISABLE="$RC_TO_DISABLE bluetoothd"
  RC_TO_DISABLE="$RC_TO_DISABLE pulseaudio"
  RC_TO_DISABLE="$RC_TO_DISABLE mpd"
  RC_TO_DISABLE="$RC_TO_DISABLE igmpproxy"
  RC_TO_DISABLE="$RC_TO_DISABLE socat"
  RC_TO_DISABLE="$RC_TO_DISABLE dump1090"
